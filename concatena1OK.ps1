...
for ($i = 1; $i -le $parts; $i++) {
    $name = "projeto_concatenado_part_{0:D2}_of_10.txt" -f $i
    if (Test-Path $name) {
...
for ($part = 1; $part -le $parts; $part++) {
    ...
    $fileName = "projeto_concatenado_part_{0:D2}_of_10.txt" -f $part
    ...
    Add-Content $fileName "***************************************INICIO DO ARQUIVO $part/10********************************"
    ...
    Add-Content $fileName "***********************************FINAL DO ARQUIVO $part/10*************************"
