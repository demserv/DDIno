...
typedef enum {
    EVENT_ID_NONE           = 0,
    EVENT_ID_SAFE_OFF       = 1,
    EVENT_ID_EMERGENCY      = 2,
    EVENT_ID_DEGRADED       = 3,
    EVENT_ID_NORMAL         = 4,
    EVENT_ID_ALERT_RAISED   = 5,
    EVENT_ID_ALERT_ACKED    = 6,
    EVENT_ID_PLUG_TOGGLED   = 7,
    EVENT_ID_FEED_START     = 8,
    EVENT_ID_FEED_END       = 9,
    EVENT_ID_CONFIG_CHANGED = 10,
    EVENT_ID_WIZARD_DONE    = 11,
    EVENT_ID_RESET_START    = 12,
    EVENT_ID_TEMP_CRITICAL  = 13,
    EVENT_ID_OVER_CURRENT   = 14,
    EVENT_ID_ATO_OVERFLOW   = 15,
    EVENT_ID_SD_MOUNTED     = 16,
    EVENT_ID_SD_UNMOUNTED   = 17,
    EVENT_ID_WDT_TIMEOUT    = 18,
    EVENT_ID_BOOT_COMPLETE  = 19,
    EVENT_ID_COUNT
} event_id_t;

#define EVENT_BUS_MAX_SUBSCRIBERS  8
#define EVENT_BUS_MAX_PENDING     16
