/* @requirement RF-HW-001 a RF-HW-046 limites f├¡sicos can├┤nicos */
// @requirement RNF-HARDWARE-001 Constantes f├¡sicas e de hardware (N├âO confundir com par├ómetros operacionais)
...
// ============================================================
// hardware_config.h ÔÇö Hardware invariants
// ============================================================
...
// --- pH sensor (GPIO livre ÔÇö decisao normativa 2026-06-30) ---
#define HW_PH_SENSOR_SPAN                (14.0f)

// --- Rel├® prioritario boot delay P01/P02 (decisao normativa 2026-06-30) ---
#define HW_RELAY_P01_P02_STARTUP_DELAY_MS (5000U)

// --- Lockout p├│s-OFF manual (RF-PLUG-008) ---
 ...
 * N├úo normativo como param operacional ÔÇö sem entrada dedicada no cat├ílogo NVS. */
