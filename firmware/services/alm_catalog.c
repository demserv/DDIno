// @requirement RF-ALERT-001/RF-ALERT-003 Tabela canônica de ALMs (Tabela 9.5-A, SRS v3.11).
// Onde a SRS lista uma faixa de severidade (ex.: HIGH/CRITICAL) adota-se a mais severa
// como padrão; onde lista auto-clear condicional, adota-se o comportamento conservador
...
/* Índice = (ALM id - 1). Mantém a ordem ALM-001..ALM-065. */
static const alm_meta_t s_catalog[ALM_ID_MAX] = {
    ...
    /* 062 */ { SEV_CRIT, CAT_SEC,  true,  false, "Revisar tentativas de login" },
